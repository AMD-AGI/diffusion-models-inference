...
```bash
pip install --upgrade git+https://github.com/AMD-AGI/diffusion-models-inference.git#subdirectory=bulkbench
```
...
latencies for statistical significance. This section explains how to control that and
craft practically any comparison your project needs. If comparisons the tool make by default are
enough for you, you can stop reading here.
