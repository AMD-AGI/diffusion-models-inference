...
def makeParser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        "ignored with a warning). If the list is presen but empty, it disables the group completely. "
        ...
        "(empty list (including after stripping unknown patch set names) is an equvalent of "
