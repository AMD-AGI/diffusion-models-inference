...
def makeParser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        "The file must be a valid YAML file containing a non-empty list of patch groups. "
        "A patch group object has the following required attributes:\n"
        "- name - name of the patch group (must be unique within the file),\n"
        ...
        "A patch object may occur only once in its group. Each patch object has the following attributes:\n"
